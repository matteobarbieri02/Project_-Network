...
```{r}
mod_tab <- cbind(mod_kc, mod_la)
mod_tab
```

Louvain algorithm and Fast Greedy clustering have very similar modularity score. This means that there is no particular difference in how well the methods divide the network into communities.
